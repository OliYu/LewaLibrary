package com.lb.news.okhttp.request;
...
import static com.lb.news.okhttp.utils.Exceptions.*;
import static com.lb.news.okhttp.utils.Exceptions.illegalArgument;
...
public class PostFileRequest extends OkHttpRequest
{
    ...
    public PostFileRequest(String url, Object tag, Map<String, String> params, Map<String, String> headers, File file, MediaType mediaType,int id)
    {
        ...
        if (this.file == null)
        {
            illegalArgument("the file can not be null !");
        }
